...
Durable, project-scoped knowledge lives locally in `.claude/memory/project-memory.md`. It is ignored by Git, is not automatically injected at SessionStart, and does not travel with clones.

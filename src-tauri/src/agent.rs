...
mod tests {
    use super::{
        ...
        subagent_result, tool_result_block, tool_result_event, turn_failure_diagnostic,
        AgentConfig, AgentSpawner, BackgroundLauncher, Block, Cancels, ChatMessage, Db, Decision,
        LoopOutcome, OpenAiRefreshTransport, OpenAiRunAuth, Persist, RunAuthContext,
        RunReservation, StreamEvent, CANCELLED_SUBAGENT_RESULT, CANCELLED_TOOL_RESULT,

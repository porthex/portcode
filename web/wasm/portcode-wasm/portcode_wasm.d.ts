...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h2b16843940da3242: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h56a33726b6464870: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hbd23976738aa7f95: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h6f36043c7a808c9e: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h6c2424208b56a1a1: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1f424cc1be8b5c3f: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h24be1ebd8eb33125: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h871dbebfa7827dc8: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h818518dae231d658: (a: number, b: number) => void;
